...
PROCEDURE_OUTPUT_ANALYSIS = {
    ...
    "JIVO_OIL": [
        ...
        {
            "hana_column": "RequiredQty",
            "hana_type": "DECIMAL(19,2)",
            "mapped_column": "base_required_qty",
            "business_meaning": "Forecast/BOM requirement before final stock adjustment.",
        },
        {
            "hana_column": "Min Stock",
            "hana_type": "DECIMAL(28,6)",
        ...
        {
            "hana_column": "Final Required Qty",
            "hana_type": "DECIMAL(30,6)",
            "mapped_column": "required_qty",
            "business_meaning": "Final requirement gap after stock and min-stock adjustment.",
        },
    ],
}
