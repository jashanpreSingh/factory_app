...
class GRPOService:
    ...
    def get_service_grpo_preview_data(self, dispatch_plan_id: int) -> Dict[str, Any]:
        ...
        vehicle_no = self._dispatch_vehicle_no(dispatch_plan)
        driver_name = self._dispatch_driver_name(dispatch_plan)
        ...
        return {
            ...
            "linked_vehicle_entry_id": self._dispatch_linked_vehicle_entry_id(dispatch_plan),
            "linked_vehicle_entry_no": self._dispatch_linked_vehicle_entry_no(dispatch_plan),
